...
export default class NavTwo extends Component<any, any> {
    constructor(props){
        super(props)
        this.state = {
          sticky: false
    ...
    mobileMenu = () => {
        //Mobile Menu Toggle
        let mainNavToggler = document.querySelector<HTMLElement>(".menu-toggler");
        let mainNav = document.querySelector<HTMLElement>(".main-navigation");

        if (!mainNavToggler || !mainNav) return;
